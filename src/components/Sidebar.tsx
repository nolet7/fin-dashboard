...
import { Wallet, TrendingUp, Send, BarChart3, Settings, ChevronLeft, ChevronRight, LogOut } from 'lucide-react';
    ...
    >
      ...
      <div className="p-4 border-t border-light-border dark:border-dark-border">
        <div className="space-y-3">
          ...
          <motion.button
            onClick={logout}
            className="w-full flex items-center space-x-3 p-3 rounded-xl text-light-text-secondary dark:text-dark-text-secondary hover:bg-red-500/10 hover:text-red-400 transition-all group"
            whileHover={{ scale: 1.02 }}
            whileTap={{ scale: 0.98 }}
